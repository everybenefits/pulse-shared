...
export declare const carrierStateRateImportRowSchema: z.ZodPreprocess<z.ZodObject<{
    carrier_code: z.ZodPreprocess<z.ZodString, unknown>;
    carrier_name: z.ZodPreprocess<z.ZodString, unknown>;
    state: z.ZodPreprocess<z.ZodPipe<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, z.ZodString>, unknown>;
    ...
    active: z.ZodPreprocess<z.ZodPipe<z.ZodOptional<z.ZodUnion<readonly [z.ZodBoolean, z.ZodEnum<{
        ...
        yes: "yes";
        no: "no";
    }>]>>, z.ZodTransform<boolean, boolean | "0" | "1" | "true" | "false" | "TRUE" | "FALSE" | "yes" | "no" | undefined>>, unknown>;
