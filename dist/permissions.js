...
exports.PERMISSION_CATALOG = [
    ...
    {
        key: "admin.release_notes.read",
        category: "admin",
        name: "View release notes",
        description: "List release notes in Admin",
    },
    {
        key: "admin.release_notes.write",
        category: "admin",
        name: "Edit release notes",
        description: "Create, publish, and delete release notes",
    },
    // org
    {
        key: "org.tree.read",
    ...
    {
        key: "org.members.read",
        category: "org",
        name: "View agency members",
        description: "List agents assigned to owned agency subtrees",
    },
    {
        key: "org.members.assign",
        category: "org",
        name: "Assign agency members",
        description: "Assign agents to org nodes within owned agency subtrees",
    },
...
function resolvePermissionsFromRoleDoc(roleId, data) {
    ...
    if (data && data.active !== false) {
        ...
        if (filtered.length === 0 && isBuiltinRoleId(normalized)) {
            return [...getDefaultPermissionsForRole(normalized)];
        }
        return filtered;
    }
...
exports.DEFAULT_ROLE_PERMISSIONS = {
    ...
    admin: [
        ...
        "admin.banners.read",
        "admin.banners.write",
        "admin.release_notes.read",
        "admin.release_notes.write",
        "org.tree.read",
        "org.agency.create",
        "org.agency.update",
...
function canAssignRoleByAuthority(options) {
    ...
    if (targetRank >= actorRank)
        return false;
    const targetNormalized = options.targetRole === "teacher" ? "instructor" : options.targetRole.trim();
    // Built-ins are code-defined; rank is enough. Subset applies to custom roles only
    // (staff need not hold every member-facing key like commission.statements.self).
    if (isBuiltinRoleId(targetNormalized))
        return true;
...
exports.DEFAULT_ROLE_META = {
    ...
    agency_owner: {
        name: "Agency owner",
        description: "Owns one or more agencies; self-service agency management in Pulse Web.",
        category: "sales",
        sortOrder: 25,
        locked: false,
        editableBySystemOnly: true,
